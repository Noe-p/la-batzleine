import { H3, P14 } from '@/components/Texts';
...
export function NavBar(props: NavBarProps): React.JSX.Element {
  ...
  function handleScroll() {
    ...
    const sections = Object.values(NavKeys).map((link) => ({
      link,
  ...
  function setLinkSelected(link: NavKeys) {
...
const MobileLink = tw(H3)<{ $selected?: boolean }>`
  uppercase
