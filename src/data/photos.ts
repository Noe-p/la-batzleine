...
export const JARDIN: Photo[] = [
  {
    ...
    description:
      'Une magnifique vue du jardin montrant une variété de fleurs colorées et un espace vert bien entretenu.',
  },
  {
    filters: [FILTERS.JARDIN],
    ...
    description:
      'Un jardin avec des allées de pierre sinueuses et des arbres majestueux créant une atmosphère paisible.',
  },
  {
    filters: [FILTERS.JARDIN],
    ...
    description:
      'Un coin détente confortable dans le jardin avec des chaises longues et un environnement paisible.',
  },
  {
    filters: [FILTERS.JARDIN],
    ...
    description:
      'Une belle fontaine située au centre du jardin entourée de diverses plantes et fleurs.',
  },
  {
    filters: [FILTERS.JARDIN],
    ...
    description:
      'Un vaste jardin avec une pelouse verte impeccable et des arbustes taillés soigneusement.',
  },
  {
    filters: [FILTERS.JARDIN],
...
export const RDC: Photo[] = [
  ...
  },
  {
    ...
    name: 'vue-du-rdc-7',
    id: '9726de22-2f38-401c-896e-2e588d7b67b2',
    alt: 'Salon lumineux au rez-de-chaussée',
    description:
      'Un salon lumineux et spacieux situé au rez-de-chaussée, avec des meubles modernes et une grande fenêtre.',
  },
  ...
  },
  {
    ...
    description:
      'Une salle à manger élégante au rez-de-chaussée, avec une grande table en bois et des chaises confortables.',
  },
  {
    filters: [FILTERS.RDC],
    ...
    description:
      'Un bureau moderne et fonctionnel au rez-de-chaussée, idéal pour le travail à domicile avec un bureau spacieux et des étagères.',
  },
  {
    filters: [FILTERS.RDC],
    ...
    description:
      'Une salle de bain bien aménagée au rez-de-chaussée, avec une douche moderne et des équipements de haute qualité.',
  },
  {
    filters: [FILTERS.RDC],
...
export const ETAGE1: Photo[] = [
  {
    ...
    description:
      'Une chambre principale spacieuse et lumineuse située à l’étage, avec un grand lit et une décoration élégante.',
  },
  {
    filters: [FILTERS.ETAGE1],
    ...
    description:
      'Une salle de bain moderne et bien équipée à l’étage, avec une grande baignoire et un lavabo design.',
  },
];
...
export const CHAMBRE1: Photo[] = [
  {
    ...
    description:
      'Une chambre d’invité lumineuse et accueillante, avec un lit double confortable et une décoration chaleureuse.',
  },
  {
    filters: [FILTERS.CHAMBRE1],
    ...
    description:
      'Une chambre d’invité offrant une vue magnifique sur le jardin, avec un espace de rangement ample et une ambiance relaxante.',
  },
];
...
export const CHAMBRE2: Photo[] = [
  {
    ...
    description:
      'Une chambre d’enfant colorée et joyeuse, avec des meubles adaptés aux enfants et des jouets.',
  },
  {
    filters: [FILTERS.CHAMBRE2],
    ...
    description:
      'Une chambre d’enfant avec un espace de jeu dédié, décorée de manière ludique et fonctionnelle.',
  },
  {
    filters: [FILTERS.CHAMBRE2],
    ...
    description:
      'Une chambre d’enfant équipée d’un lit superposé, idéale pour deux enfants, avec un espace de rangement intégré.',
  },
];
...
export const SDB: Photo[] = [
  {
    ...
    description:
      'Une petite salle de bain bien aménagée, avec une douche et des rangements optimisés pour un espace réduit.',
  },
  {
    filters: [FILTERS.SDB],
    ...
    description:
      'Une salle de bain spacieuse avec une grande baignoire et une double vasque, idéale pour une famille.',
  },

  {
    ...
    description:
      'Une salle de bain moderne dotée d’une douche à l’italienne, de carrelage design et d’équipements haut de gamme.',
  },
];
